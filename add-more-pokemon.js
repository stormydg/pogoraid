...
const newPokemon = [
  ...
  { name: 'Staraptor', pokedex: 398, types: 'Normal,Flying', attack: 234, defense: 140, hp: 198,
    ...
    moveset: 'Wing Attack / Brave Bird' },
  ...
  { name: 'Arcanine', pokedex: 59, types: 'Fire', attack: 227, defense: 166, hp: 207,
    weaknesses: 'Water:1.6,Ground:1.6,Rock:1.6', category: 'Normal', shiny: 1,
    moveset: 'Fire Fang / Flamethrower' },
  ...
  { name: 'Flygon', pokedex: 330, types: 'Ground,Dragon', attack: 205, defense: 168, hp: 190,
    ...
    moveset: 'Dragon Tail / Earth Power' },

  // Milotic - #350 - Water
  { name: 'Milotic', pokedex: 350, types: 'Water', attack: 192, defense: 219, hp: 216,
    weaknesses: 'Electric:1.6,Grass:1.6', category: 'Normal', shiny: 1,
    moveset: 'Waterfall / Surf' },

  // Leafeon - #470 - Grass
  { name: 'Leafeon', pokedex: 470, types: 'Grass', attack: 216, defense: 219, hp: 163,
    weaknesses: 'Fire:1.6,Ice:1.6,Poison:1.6,Flying:1.6,Bug:1.6', category: 'Normal', shiny: 1,
    moveset: 'Razor Leaf / Leaf Blade' },

  // Glaceon - #471 - Ice
  { name: 'Glaceon', pokedex: 471, types: 'Ice', attack: 238, defense: 205, hp: 163,
    weaknesses: 'Fire:1.6,Fighting:1.6,Rock:1.6,Steel:1.6', category: 'Normal', shiny: 1,
    moveset: 'Frost Breath / Avalanche' },
];

const insertPokemon = db.prepare(
  "INSERT OR IGNORE INTO pokemon (name, pokedex_number, types, attack, defense, hp, weaknesses, category, shiny_released, best_moveset) VALUES (@name, @pokedex, @types, @attack, @defense, @hp, @weaknesses, @category, @shiny, @moveset)"
);
